  ...
  return (
    <section className="contact section" id="contact" aria-labelledby="contact-heading">
      ...
      <div className="contact-intro">
        ...
        <p className="contact-copy">Webová stránka, aplikácia alebo softvér na mieru. Napíšte nám stručne, čo chcete vytvoriť — ozveme sa vám s jasným ďalším krokom.</p>
        <div className="contact-details">
          <p>Sídlo v Piešťanoch.</p>
    ...
    <div className="privacy-backdrop" onMouseDown={event => event.target === event.currentTarget && onClose()}>
      <section className="privacy-modal" role="dialog" aria-modal="true" aria-labelledby="privacy-heading" ref={dialogRef} tabIndex="-1">
        ...
        <div className="privacy-content">
          <p className="privacy-intro">Tieto informácie vysvetľujú spracúvanie osobných údajov pri kontaktných dopytoch a zabezpečení webovej stránky URVEO vrátane používania cookies a úložísk prehliadača.<br/>Posledná aktualizácia: <time dateTime="2026-09-14">14. septembra 2026</time>.</p>
          <article><span>01</span><div><h3>Prevádzkovateľ</h3>
            <div className="privacy-placeholder"><strong>Obchodné meno:</strong><br/>Alex Volák - URVEO<br/><br/><strong>Miesto podnikania:</strong><br/>E. F. Scherera 4797/5, 921 01 Piešťany<br/><br/><strong>IČO:</strong><br/>50 604 431<br/><br/><strong>Číslo živnostenského registra:</strong><br/>230-19419<br/><br/><strong>Kontaktné osoby URVEO:</strong><br/>Alex Volák a Peter Odorčák<br/><br/><strong>Kontaktný e-mail:</strong><br/><a href="mailto:info@urveo.sk">info@urveo.sk</a></div></div></article>
          <article><span>02</span><div><h3>Aké údaje spracúvame</h3><p>Pri odoslaní formulára spracúvame meno, e-mailovú adresu, vybranú oblasť záujmu, obsah správy a automaticky vytvorený čas odoslania. Pri ďalšej komunikácii spracúvame aj údaje, ktoré nám v nej poskytnete. Na ochranu webu a kontaktného formulára pred zneužitím sa spracúvajú aj nevyhnutné technické a bezpečnostné údaje vrátane IP adresy.</p></div></article>
          ...
          <article><span>04</span><div><h3>Zabezpečenie webu a formulára</h3><p>Na prevádzku a ochranu webu využívame Cloudflare. Služba Cloudflare Turnstile pomáha chrániť kontaktný formulár pred automatizovaným zneužitím a načítava sa už pri jeho zobrazení.</p><p>Cloudflare môže na tieto účely spracúvať technické a bezpečnostné údaje vrátane IP adresy a prevádzkových záznamov. IP adresu nepridávame do e-mailu s dopytom.</p></div></article>
          ...
          <article><span>06</span><div><h3>Doba uchovávania</h3><p>Údaje z bežných dopytov a súvisiacu e-mailovú komunikáciu uchovávame najviac 12 mesiacov od poslednej komunikácie. Výnimkou je vznik zmluvného alebo obchodného vzťahu alebo potreba dlhšieho uchovávania na preukazovanie, uplatňovanie či obhajovanie právnych nárokov alebo splnenie zákonných povinností.</p><p>Toto pravidlo uplatňujeme aj na dopyty a súvisiacu komunikáciu v našej e-mailovej schránke. Technické a bezpečnostné záznamy a záložné kópie poskytovateľov môžu mať odlišné lehoty uchovávania podľa ich účelu a podmienok príslušnej služby.</p></div></article>
          <article><span>07</span><div><h3>Príjemcovia a spracovatelia</h3><ul><li><strong>Cloudflare vrátane služby Turnstile</strong> — poskytovanie infraštruktúry, zabezpečenie webu a ochrana kontaktného formulára,</li><li><strong>Resend</strong> — technické doručovanie e-mailov z kontaktného formulára,</li><li><strong>Google / Gmail</strong> — prijímanie, uchovávanie a vybavovanie e-mailovej komunikácie.</li></ul><p>Správy sa odosielajú cez Resend z identity URVEO &lt;noreply@urveo.sk&gt; na info@urveo.sk. Adresu noreply@urveo.sk používame ako technickú adresu odosielateľa správ z kontaktného formulára. Váš e-mail sa použije ako adresa na odpoveď (reply_to). Automatický potvrdzovací e-mail vám neposielame.</p></div></article>
          <article><span>08</span><div><h3>Prenosy mimo EÚ/EHP</h3><p>Niektorí poskytovatelia môžu spracúvať osobné údaje aj mimo EÚ/EHP. Takéto prenosy podliehajú pravidlám ochrany osobných údajov vrátane požiadavky na primerané záruky tam, kde sú potrebné, napríklad uplatniteľné štandardné zmluvné doložky. Ďalšie informácie môžete získať na info@urveo.sk.</p></div></article>
